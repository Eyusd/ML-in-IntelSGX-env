...
enum
{
    linereg_fcn_id_enclave_init = 0,
    linereg_fcn_id_enclave_old_to_new = 1,
    linereg_fcn_id_enclave_new_to_old = 2,
    linereg_fcn_id_enclave_train = 3,
    linereg_fcn_id_enclave_infer = 4,
    linereg_fcn_id_get_enclave_format_settings = 5,
    linereg_fcn_id_get_evidence_with_public_key = 6,
    linereg_fcn_id_verify_evidence_and_set_public_key = 7,
    linereg_fcn_id_generate_encrypted_message = 8,
    linereg_fcn_id_process_encrypted_message = 9,
    linereg_fcn_id_oe_verify_report_ecall = 10,
    linereg_fcn_id_oe_get_sgx_report_ecall = 11,
    linereg_fcn_id_oe_get_report_v2_ecall = 12,
    linereg_fcn_id_oe_verify_local_report_ecall = 13,
    linereg_fcn_id_oe_sgx_init_context_switchless_ecall = 14,
    linereg_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall = 15,
    linereg_fcn_id_trusted_call_id_max = OE_ENUM_MAX
};
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    enclave_init_args_t* pargs_in = (enclave_init_args_t*)input_buffer;
    enclave_init_args_t* pargs_out = (enclave_init_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    enclave_old_to_new_args_t* pargs_in = (enclave_old_to_new_args_t*)input_buffer;
    enclave_old_to_new_args_t* pargs_out = (enclave_old_to_new_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    enclave_new_to_old_args_t* pargs_in = (enclave_new_to_old_args_t*)input_buffer;
    enclave_new_to_old_args_t* pargs_out = (enclave_new_to_old_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    enclave_train_args_t* pargs_in = (enclave_train_args_t*)input_buffer;
    enclave_train_args_t* pargs_out = (enclave_train_args_t*)output_buffer;
    ...
    /* Set in and in-out pointers. */
    if (pargs_in->values)
        OE_SET_IN_POINTER(values, sizeof(double[9]), double*);

    /* Set out and in-out pointers. */
    /* In-out parameters are copied to output buffer. */
    if (pargs_in->output)
        OE_SET_OUT_POINTER(output, sizeof(double), double*);
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    enclave_infer_args_t* pargs_in = (enclave_infer_args_t*)input_buffer;
    enclave_infer_args_t* pargs_out = (enclave_infer_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    get_enclave_format_settings_args_t* pargs_in = (get_enclave_format_settings_args_t*)input_buffer;
    get_enclave_format_settings_args_t* pargs_out = (get_enclave_format_settings_args_t*)output_buffer;
    ...
    /* Set out and in-out pointers. */
    /* In-out parameters are copied to output buffer. */
    if (pargs_in->format_settings)
        OE_SET_OUT_POINTER(format_settings, sizeof(uint8_t*), uint8_t**);
    if (pargs_in->format_settings_size)
        OE_SET_OUT_POINTER(format_settings_size, sizeof(size_t), size_t*);
    ...
    /* Call user function. */
    pargs_out->_retval = get_enclave_format_settings(
        (const oe_uuid_t*)pargs_in->format_id,
        pargs_in->format_settings,
        pargs_in->format_settings_size);
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    get_evidence_with_public_key_args_t* pargs_in = (get_evidence_with_public_key_args_t*)input_buffer;
    get_evidence_with_public_key_args_t* pargs_out = (get_evidence_with_public_key_args_t*)output_buffer;
    ...
    if (pargs_in->format_id)
        OE_SET_IN_POINTER(format_id, sizeof(oe_uuid_t), oe_uuid_t*);
    if (pargs_in->format_settings_buffer)
        OE_SET_IN_POINTER(format_settings_buffer, pargs_in->format_settings_size, uint8_t*);
    ...
    if (pargs_in->evidence_buffer)
        OE_SET_OUT_POINTER(evidence_buffer, sizeof(uint8_t*), uint8_t**);
    if (pargs_in->evidence_buffer_size)
        OE_SET_OUT_POINTER(evidence_buffer_size, sizeof(size_t), size_t*);
    ...
    /* Call user function. */
    pargs_out->_retval = get_evidence_with_public_key(
        (const oe_uuid_t*)pargs_in->format_id,
        pargs_in->format_settings_buffer,
        pargs_in->format_settings_size,
        pargs_in->pem_key,
        pargs_in->pem_key_size,
        pargs_in->evidence_buffer,
        pargs_in->evidence_buffer_size);
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    verify_evidence_and_set_public_key_args_t* pargs_in = (verify_evidence_and_set_public_key_args_t*)input_buffer;
    verify_evidence_and_set_public_key_args_t* pargs_out = (verify_evidence_and_set_public_key_args_t*)output_buffer;
    ...
    if (pargs_in->format_id)
        OE_SET_IN_POINTER(format_id, sizeof(oe_uuid_t), oe_uuid_t*);
    if (pargs_in->pem_key)
        OE_SET_IN_POINTER(pem_key, ((size_t)pargs_in->pem_key_size * sizeof(uint8_t)), uint8_t*);
    if (pargs_in->evidence)
        OE_SET_IN_POINTER(evidence, ((size_t)pargs_in->evidence_size * sizeof(uint8_t)), uint8_t*);
    ...
    /* Call user function. */
    pargs_out->_retval = verify_evidence_and_set_public_key(
        (const oe_uuid_t*)pargs_in->format_id,
        pargs_in->pem_key,
        pargs_in->pem_key_size,
        pargs_in->evidence,
        pargs_in->evidence_size);
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    process_encrypted_message_args_t* pargs_in = (process_encrypted_message_args_t*)input_buffer;
    process_encrypted_message_args_t* pargs_out = (process_encrypted_message_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = process_encrypted_message(
        pargs_in->data,
        pargs_in->size);
...
enum
{
    linereg_fcn_id_oe_syscall_epoll_create1_ocall = 0,
    linereg_fcn_id_oe_syscall_epoll_wait_ocall = 1,
    linereg_fcn_id_oe_syscall_epoll_wake_ocall = 2,
    linereg_fcn_id_oe_syscall_epoll_ctl_ocall = 3,
    linereg_fcn_id_oe_syscall_epoll_close_ocall = 4,
    linereg_fcn_id_oe_syscall_open_ocall = 5,
    linereg_fcn_id_oe_syscall_read_ocall = 6,
    linereg_fcn_id_oe_syscall_write_ocall = 7,
    linereg_fcn_id_oe_syscall_readv_ocall = 8,
    linereg_fcn_id_oe_syscall_writev_ocall = 9,
    linereg_fcn_id_oe_syscall_lseek_ocall = 10,
    linereg_fcn_id_oe_syscall_pread_ocall = 11,
    linereg_fcn_id_oe_syscall_pwrite_ocall = 12,
    linereg_fcn_id_oe_syscall_close_ocall = 13,
    linereg_fcn_id_oe_syscall_flock_ocall = 14,
    linereg_fcn_id_oe_syscall_fsync_ocall = 15,
    linereg_fcn_id_oe_syscall_fdatasync_ocall = 16,
    linereg_fcn_id_oe_syscall_dup_ocall = 17,
    linereg_fcn_id_oe_syscall_opendir_ocall = 18,
    linereg_fcn_id_oe_syscall_readdir_ocall = 19,
    linereg_fcn_id_oe_syscall_rewinddir_ocall = 20,
    linereg_fcn_id_oe_syscall_closedir_ocall = 21,
    linereg_fcn_id_oe_syscall_stat_ocall = 22,
    linereg_fcn_id_oe_syscall_fstat_ocall = 23,
    linereg_fcn_id_oe_syscall_access_ocall = 24,
    linereg_fcn_id_oe_syscall_link_ocall = 25,
    linereg_fcn_id_oe_syscall_unlink_ocall = 26,
    linereg_fcn_id_oe_syscall_rename_ocall = 27,
    linereg_fcn_id_oe_syscall_truncate_ocall = 28,
    linereg_fcn_id_oe_syscall_ftruncate_ocall = 29,
    linereg_fcn_id_oe_syscall_mkdir_ocall = 30,
    linereg_fcn_id_oe_syscall_rmdir_ocall = 31,
    linereg_fcn_id_oe_syscall_fcntl_ocall = 32,
    linereg_fcn_id_oe_syscall_ioctl_ocall = 33,
    linereg_fcn_id_oe_syscall_poll_ocall = 34,
    linereg_fcn_id_oe_syscall_kill_ocall = 35,
    linereg_fcn_id_oe_syscall_close_socket_ocall = 36,
    linereg_fcn_id_oe_syscall_socket_ocall = 37,
    linereg_fcn_id_oe_syscall_shutdown_sockets_device_ocall = 38,
    linereg_fcn_id_oe_syscall_socketpair_ocall = 39,
    linereg_fcn_id_oe_syscall_connect_ocall = 40,
    linereg_fcn_id_oe_syscall_accept_ocall = 41,
    linereg_fcn_id_oe_syscall_bind_ocall = 42,
    linereg_fcn_id_oe_syscall_listen_ocall = 43,
    linereg_fcn_id_oe_syscall_recvmsg_ocall = 44,
    linereg_fcn_id_oe_syscall_sendmsg_ocall = 45,
    linereg_fcn_id_oe_syscall_recv_ocall = 46,
    linereg_fcn_id_oe_syscall_recvfrom_ocall = 47,
    linereg_fcn_id_oe_syscall_send_ocall = 48,
    linereg_fcn_id_oe_syscall_sendto_ocall = 49,
    linereg_fcn_id_oe_syscall_recvv_ocall = 50,
    linereg_fcn_id_oe_syscall_sendv_ocall = 51,
    linereg_fcn_id_oe_syscall_shutdown_ocall = 52,
    linereg_fcn_id_oe_syscall_setsockopt_ocall = 53,
    linereg_fcn_id_oe_syscall_getsockopt_ocall = 54,
    linereg_fcn_id_oe_syscall_getsockname_ocall = 55,
    linereg_fcn_id_oe_syscall_getpeername_ocall = 56,
    linereg_fcn_id_oe_syscall_getaddrinfo_open_ocall = 57,
    linereg_fcn_id_oe_syscall_getaddrinfo_read_ocall = 58,
    linereg_fcn_id_oe_syscall_getaddrinfo_close_ocall = 59,
    linereg_fcn_id_oe_syscall_getnameinfo_ocall = 60,
    linereg_fcn_id_oe_syscall_nanosleep_ocall = 61,
    linereg_fcn_id_oe_syscall_getpid_ocall = 62,
    linereg_fcn_id_oe_syscall_getppid_ocall = 63,
    linereg_fcn_id_oe_syscall_getpgrp_ocall = 64,
    linereg_fcn_id_oe_syscall_getuid_ocall = 65,
    linereg_fcn_id_oe_syscall_geteuid_ocall = 66,
    linereg_fcn_id_oe_syscall_getgid_ocall = 67,
    linereg_fcn_id_oe_syscall_getegid_ocall = 68,
    linereg_fcn_id_oe_syscall_getpgid_ocall = 69,
    linereg_fcn_id_oe_syscall_getgroups_ocall = 70,
    linereg_fcn_id_oe_syscall_uname_ocall = 71,
    linereg_fcn_id_oe_get_supported_attester_format_ids_ocall = 72,
    linereg_fcn_id_oe_get_qetarget_info_ocall = 73,
    linereg_fcn_id_oe_get_quote_ocall = 74,
    linereg_fcn_id_oe_get_quote_verification_collateral_ocall = 75,
    linereg_fcn_id_oe_verify_quote_ocall = 76,
    linereg_fcn_id_oe_sgx_get_cpuid_table_ocall = 77,
    linereg_fcn_id_oe_sgx_backtrace_symbols_ocall = 78,
    linereg_fcn_id_oe_sgx_thread_wake_wait_ocall = 79,
    linereg_fcn_id_oe_sgx_wake_switchless_worker_ocall = 80,
    linereg_fcn_id_oe_sgx_sleep_switchless_worker_ocall = 81,
    linereg_fcn_id_untrusted_call_max = OE_ENUM_MAX
};
    ...
    int flags)
{
    ...
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_epoll_create1_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int timeout)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_epoll_wait_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_epoll_wake_ocall(int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_epoll_wake_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_epoll_event* event)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_epoll_ctl_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t epfd)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_epoll_close_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_mode_t mode)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_open_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t count)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_read_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t count)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_write_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t iov_buf_size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_readv_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t iov_buf_size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_writev_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int whence)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_lseek_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_off_t offset)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_pread_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_off_t offset)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_pwrite_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t fd)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_close_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int operation)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_flock_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t fd)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_fsync_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t fd)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_fdatasync_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t oldfd)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_dup_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    const char* name)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_opendir_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_dirent* entry)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_readdir_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_rewinddir_ocall(uint64_t dirp)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_rewinddir_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint64_t dirp)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_closedir_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_stat_t* buf)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_stat_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_stat_t* buf)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_fstat_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int mode)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_access_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    const char* newpath)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_link_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    const char* pathname)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_unlink_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    const char* newpath)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_rename_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_off_t length)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_truncate_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_off_t length)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_ftruncate_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_mode_t mode)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_mkdir_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    const char* pathname)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_rmdir_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    void* argout)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_fcntl_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    void* argout)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_ioctl_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int timeout)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_poll_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int signum)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_kill_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t sockfd)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_close_socket_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int protocol)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_socket_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t sockfd)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_shutdown_sockets_device_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t sv[2])
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_socketpair_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t addrlen)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_connect_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t* addrlen_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_accept_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t addrlen)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_bind_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int backlog)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_listen_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int flags)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_recvmsg_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int flags)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_sendmsg_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int flags)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_recv_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t* addrlen_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_recvfrom_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int flags)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_send_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t addrlen)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_sendto_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t iov_buf_size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_recvv_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t iov_buf_size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_sendv_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int how)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_shutdown_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t optlen)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_setsockopt_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t* optlen_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_getsockopt_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t* addrlen_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_getsockname_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t* addrlen_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_getpeername_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint64_t* handle)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_getaddrinfo_open_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    char* ai_canonname)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_getaddrinfo_read_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint64_t handle)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_getaddrinfo_close_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int flags)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_getnameinfo_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_timespec* rem)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_nanosleep_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_getpid_ocall(int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_getpid_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_getppid_ocall(int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_getppid_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_getpgrp_ocall(int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_getpgrp_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_getuid_ocall(unsigned int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_getuid_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_geteuid_ocall(unsigned int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_geteuid_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_getgid_ocall(unsigned int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_getgid_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_getegid_ocall(unsigned int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_getegid_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int pid)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_getpgid_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    unsigned int* list)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_getgroups_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_utsname* buf)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_syscall_uname_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t* format_ids_size_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_get_supported_attester_format_ids_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    sgx_target_info_t* target_info)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_get_qetarget_info_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t* quote_size_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_get_quote_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t* qe_identity_issuer_chain_size_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_get_quote_verification_collateral_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint32_t qe_identity_issuer_chain_size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_verify_quote_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t cpuid_table_buffer_size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_sgx_get_cpuid_table_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t* symbols_buffer_size_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_sgx_backtrace_symbols_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint64_t self_tcs)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_sgx_thread_wake_wait_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_sgx_wake_switchless_worker_ocall(oe_host_worker_context_t* context)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_sgx_wake_switchless_worker_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_sgx_sleep_switchless_worker_ocall(oe_enclave_worker_context_t* context)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             linereg_fcn_id_oe_sgx_sleep_switchless_worker_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
