...
enum
{
    ...
    linereg_fcn_id_generate_encrypted_message = 7,
    linereg_fcn_id_process_encrypted_message = 8,
    linereg_fcn_id_oe_verify_report_ecall = 9,
    linereg_fcn_id_oe_get_sgx_report_ecall = 10,
    linereg_fcn_id_oe_get_report_v2_ecall = 11,
    linereg_fcn_id_oe_verify_local_report_ecall = 12,
    linereg_fcn_id_oe_sgx_init_context_switchless_ecall = 13,
    linereg_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall = 14,
    ...
    size_t* output_bytes_written)
{
    ...
    /* Call user function. */
    _pargs_out->retval = get_enclave_format_settings(
    ...
    size_t* output_bytes_written)
{
    ...
    /* Call user function. */
    _pargs_out->retval = get_evidence_with_public_key(
        (const oe_uuid_t*)_pargs_in->format_id,
    ...
    size_t* output_bytes_written)
{
    ...
    /* In-out parameters are copied to output buffer. */
    if (_pargs_in->data)
        OE_SET_OUT_POINTER(data, 1, sizeof(uint8_t*), uint8_t**);
    if (_pargs_in->size)
        OE_SET_OUT_POINTER(size, 1, sizeof(size_t), size_t*);
    ...
    /* Call user function. */
    _pargs_out->retval = generate_encrypted_message(
        _pargs_in->data,
        _pargs_in->size);
    ...
    size_t* output_bytes_written)
{
    ...
    /* Set in and in-out pointers. */
    if (_pargs_in->data)
        OE_SET_IN_POINTER(data, _pargs_in->size, sizeof(uint8_t), uint8_t*);
    ...
    /* Call user function. */
    _pargs_out->retval = process_encrypted_message(
        _pargs_in->data,
        _pargs_in->size);
