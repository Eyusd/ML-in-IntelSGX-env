 ...
 */
#ifndef EDGER8R_LINEREG_T_H
#define EDGER8R_LINEREG_T_H

#include <openenclave/enclave.h>

#include "linereg_args.h"
...
void enclave_old_to_new(void);

void enclave_new_to_old(void);
