...
oe_result_t server_store_client_public_key(
    oe_enclave_t* enclave,
    uint8_t pem_client_public_key[512]);

oe_result_t server_write_rsa_pem(
    oe_enclave_t* enclave,
    uint8_t buff[512]);
...
oe_result_t server_write_ecdh_pem(
    oe_enclave_t* enclave,
    char buff[512]);

oe_result_t server_generate_secret(oe_enclave_t* enclave);
