...
bool Crypto_client::init_mbedtls(void)
{
    bool ret = false;
    int res = -1;
...
void Crypto_client::cleanup_mbedtls(void)
{
...
void Crypto_client::store_ecdh_key(char key[256])
{   
    int ret;
...
void Crypto_client::generate_secret()
{
    int ret;
